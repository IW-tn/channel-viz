(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'FMN13Uuo2NlW8VCRKG4d70BbN24GMVAt7QvTpjIKzTTgZuBS', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1867328597], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'IW-DW Test', // Replaces Xively logo in the header
		dataDuration	= '', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= '55BE47', // CSS HEX value of color to represent data (omit leading #)
